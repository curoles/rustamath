...
/// MKS unit as tuple of integer powers/dimentions (meter, kg, sec)
pub type MksUnit = (i32, i32, i32);

/// Speed of light dimentions is [m/s]
pub const SPEED_OF_LIGHT_UNIT:      MksUnit = ( 1,  0, -1);
...
/// One minute of time [s]
pub const MINUTE_UNIT:              MksUnit = ( 0,  0,  1);
...
pub const KILOMETERS_PER_HOUR_UNIT: MksUnit = ( 1,  0, -1);
