...
impl EquationMaker for VelocityEquation {
    ...
    /// ```
    /// use rustamath::physics::mechanics::linear_motion::const_accel::VelocityEquation;
    /// use rustamath::physics::{Equation, EquationMaker};
    /// use rustamath_mks::*;
...
impl VelocityByDistEquation {
    ...
    ///
    /// ```
    /// use rustamath::physics::mechanics::linear_motion::const_accel::VelocityByDistEquation;
    /// use rustamath_mks::*;
...
impl EquationMaker for VelocityByDistEquation {
    ...
    /// ```
    /// use rustamath::physics::mechanics::linear_motion::const_accel::VelocityByDistEquation;
    /// use rustamath::physics::EquationMaker;
    /// use rustamath_mks::*;
...
impl DistanceByVelEquation {
    ...
    ///
    /// ```
    /// use rustamath::physics::mechanics::linear_motion::const_accel::DistanceByVelEquation;
    /// use rustamath_mks::*;
